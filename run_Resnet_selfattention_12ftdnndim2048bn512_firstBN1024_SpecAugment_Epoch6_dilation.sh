...
test_sets2="eval_fangyi_online_bf eval_gss_ali_1024_256"
gmm=tri3
...
dir=exp/chain_train_worn_gss_BFmultiANDseletedarray_comb2s_cleaned_rvb/ResnetDyliu_selfattention_12ftdnndim2048bn512_firstBN1024_SpecAugment_Epoch6_Dilation
...
if [ $stage -le 13 ]; then
  ...
  attention-relu-renorm-layer name=att1 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att1_prj dim=2048 $linear_opts
  no-op-component name=att1_sum input=Sum(tdnnf7,att1_prj)
  ...
  attention-relu-renorm-layer name=att2 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att2_prj dim=2048 $linear_opts
  no-op-component name=att2_sum input=Sum(tdnnf9,att2_prj)
  ...
  attention-relu-renorm-layer name=att3 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att3_prj dim=2048 $linear_opts
  no-op-component name=att3_sum input=Sum(tdnnf11,att3_prj)
  ...
  attention-relu-renorm-layer name=att4 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att4_prj dim=2048 $linear_opts
  no-op-component name=att4_sum input=Sum(tdnnf13,att4_prj)
  ...
  attention-relu-renorm-layer name=att5 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att5_prj dim=2048 $linear_opts
  no-op-component name=att5_sum input=Sum(tdnnf15,att5_prj)
  ...
  attention-relu-renorm-layer name=att6 $att_opts num-heads=8 value-dim=64 key-dim=64 num-left-inputs=5 num-right-inputs=5 time-stride=3
  linear-component name=att6_prj dim=2048 $linear_opts
  no-op-component name=att6_sum input=Sum(tdnnf17,att6_prj)
